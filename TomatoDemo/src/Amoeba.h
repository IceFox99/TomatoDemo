...
public:
	...
	virtual void Animate(Tomato::Timestep ts) override;
...
private:
	...
	float m_AnimationAccumulator = 0.0f;  // would be better as Tomato::Timestep, but that doesnt currently support operator +=

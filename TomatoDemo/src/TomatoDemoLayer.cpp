...
static std::vector<LevelDefinition> levelDefinition = {
	...
	{ 160, 88, 20, 120,
		...
		"W............................................................................................................................................................. W"
		"W............................................................................................................................................................. W"
		"W.................................................................rrrrrrrrrrrrrr..rrrrrrrrrr.................................................................. W"
		"W.................................................................rrrrrrrrrrrrr..rrrrrrrrrrr.................................................................. W"
		"W............................................................................r..r............................................................................. W"
		"W..............................................................................rr............................................................................. W"
		"W.............................................................................rrr............................................................................. W"
		"W............................................................................rrrr............................................................................. W"
		"W...................rwwwwwwwwwwwwwwwwwwwwwwr.................................rrrr................................rwwwwwwwwwwwwwwwwwwwwwwr..................... W"
		"W....................w....................w..................................rrrr.................................w....................w...................... W"
		"W....................w....................w..................................rrrr.................................w....................w...................... W"
		"W....................w....................w..................................rrrr.................................w....................w...................... W"
		"W....................w....................w..................................rrr..................................w....................w...................... W"
...
TomatoDemoLayer::TomatoDemoLayer()
: Layer("HelloBoulder")
...
void TomatoDemoLayer::OnAttach() {
	...
	for (size_t i = 0; i < m_Tiles.size(); ++i) {
		...
		m_Tiles[i] = Tomato::Texture2D::Create(path);
	}
...
void TomatoDemoLayer::OnDetach() {
}

void TomatoDemoLayer::OnUpdate(Tomato::Timestep ts) {
	TM_PROFILE_FUNCTION();
	...
	{
		TM_PROFILE_SCOPE("Render");
		Tomato::RenderCommand::SetClearColor({0.0f, 0.0f, 0.0f, 1});
		Tomato::RenderCommand::Clear();
		Tomato::Renderer2D::BeginScene(m_ViewPort.GetCamera());
		...
		for (size_t row = minRow; row < maxRow; ++row) {
			for (size_t col = minCol; col < maxCol; ++col) {
				...
				Tomato::Renderer2D::DrawQuad(position, m_TileSize, m_Tiles[(int)object.GetTile()]);
				if (object.IsPlayer()) {
	...
	glfwSetWindowTitle((GLFWwindow*)Tomato::Application::Get().GetWindow().GetNativeWindow(), "Tomato Demo");
}

void TomatoDemoLayer::OnEvent(Tomato::Event& e) {
	Tomato::EventDispatcher dispatcher(e);
	dispatcher.Dispatch<Tomato::KeyPressedEvent>(TM_BIND_EVENT_FN(TomatoDemoLayer::OnKeyPressed));
}


bool TomatoDemoLayer::OnKeyPressed(Tomato::KeyPressedEvent& e) {
	if (e.GetKeyCode() == TM_KEY_SPACE) {
		if (m_PlayerIsAlive) {
			m_GamePaused = !m_GamePaused;
		} else {
			LoadLevel(m_CurrentLevel);
		}
	} else if (e.GetKeyCode() == TM_KEY_ESCAPE) {
		LoadLevel(m_CurrentLevel);
	}
	return true;
}
...
void TomatoDemoLayer::LoadLevel(int level) {
	// Judge whether the game is end
	if (level == m_EndLevel)
		m_ViewPort = { 0.0f, 0.0f, 40.0f, 22.0f };
...
#ifdef _DEBUG
void TomatoDemoLayer::OnImGuiRender() {
	{
